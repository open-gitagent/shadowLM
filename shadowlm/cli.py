...
def finetune(
    ...
    backend: Annotated[Optional[str], typer.Option(help="auto | mlx | torch | remote | verl")] = None,
...
def generate(
    ...
    backend: Annotated[str, typer.Option(help="auto | mlx | torch | remote | verl")] = "auto",
